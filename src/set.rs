...
pub type CFSetRetainCallBack = extern "C" fn(allocator: CFAllocatorRef, value: *const c_void);
...
extern {
    pub fn CFSetCreate(allocator: CFAllocatorRef, values: *const *mut c_void, numValues: CFIndex,
    ...
    pub fn CFSetCreateMutable(allocator: CFAllocatorRef, capacity: CFIndex, callBacks: *const CFSetCallBacks)
                              -> CFMutableSetRef;
    pub fn CFSetCreateMutableCopy(allocator: CFAllocatorRef, capacity: CFIndex, theSet: CFSetRef) -> CFSetRef;
    ...
    pub fn CFSetAddValue(theSet: CFMutableSetRef, value: *const *mut c_void);
    pub fn CFSetRemoveAllValues(theSet: CFMutableSetRef);
    pub fn CFSetRemoveValue(theSet: CFMutableSetRef, value: *const *mut c_void);
